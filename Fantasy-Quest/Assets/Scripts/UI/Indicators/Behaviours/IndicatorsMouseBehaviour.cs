    ...
    public class IndicatorsMouseBehaviour : IndicatorsBehaviour
    {
        ...
        private void SubscribeToSliderSwap(Button button)
        {
            if (previousButton != null)
            {
                ...
                EffectModel.IndicatorsButtons.Left.onClick.RemoveListener(EffectModel.SlideSound.PlayClip);
                EffectModel.IndicatorsButtons.Right.onClick.RemoveListener(previousSlider.MoveRight);
                EffectModel.IndicatorsButtons.Right.onClick.RemoveListener(EffectModel.SlideSound.PlayClip);
            }
            ...
            if (button.TryGetComponent(out IHorizontalSlider slider))
            {
                ...
                EffectModel.IndicatorsButtons.Left.onClick.AddListener(EffectModel.SlideSound.PlayClip);
                EffectModel.IndicatorsButtons.Right.onClick.AddListener(slider.MoveRight);
                EffectModel.IndicatorsButtons.Right.onClick.AddListener(EffectModel.SlideSound.PlayClip);
