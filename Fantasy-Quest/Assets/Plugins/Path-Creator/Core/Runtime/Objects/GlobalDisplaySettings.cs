...
namespace PathCreation
{
    ...
    public class GlobalDisplaySettings : ScriptableObject
    {
        ...
        [Tooltip(
            "If true, control points will be hidden when the control point mode is set to automatic. Otherwise they will inactive, but still visible."
        )]
        ...
        public static GlobalDisplaySettings Load()
        {
            ...
            {
                Debug.LogWarning(
                    "Could not find DisplaySettings asset. Will use default settings instead."
                );
