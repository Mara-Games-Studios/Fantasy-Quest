...
namespace DG.Tweening
{
    public static class DOTweenModuleUI
    {
        ...
        {
            TweenerCore<Vector2, Vector2, VectorOptions> t = DOTween.To(
                () => target.effectDistance,
                x => target.effectDistance = x,
                endValue,
                duration
            );
            _ = t.SetTarget(target);
        ...
        )
        {
            ...
            _ = t.SetOptions(AxisConstraint.Z, snapping).SetTarget(target);
            return t;
        }
        ...
        )
        {
            ...
            _ = t.SetOptions(AxisConstraint.X).SetTarget(target);
            return t;
        }
        ...
        )
        {
            ...
            _ = t.SetOptions(AxisConstraint.Y).SetTarget(target);
            return t;
        }
        ...
        )
        {
            ...
            _ = s.OnUpdate(() =>
            {
                ...
                pos.y += DOVirtual.EasedValue(
                    0,
                    offsetY,
                    s.ElapsedDirectionalPercentage(),
                    Ease.OutQuad
                );
        ...
        {
            int v = fromValue;
            CultureInfo cInfo = !addThousandsSeparator
                ? null
            ...
            TweenerCore<int, int, NoOptions> t = DOTween.To(
                ...
                {
                    v = x;
                    target.text = addThousandsSeparator ? v.ToString("N0", cInfo) : v.ToString();
                },
                endValue,
                duration
            );
        ...
        )
        {
            ...
            _ = t.SetOptions(richTextEnabled, scrambleMode, scrambleChars).SetTarget(target);
            return t;
        }
        ...
        )
        {
            ...
            _ = t.SetOptions(endValueDegrees, relativeCenter, snapping).SetTarget(target);
            return t;
        }
